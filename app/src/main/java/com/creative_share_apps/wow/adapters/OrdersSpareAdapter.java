...
import com.creative_share_apps.wow.activities_fragments.activity_home.client_home.fragments.fragmen_spare_order.Fragment_Spare_Current_Orders;
import com.creative_share_apps.wow.activities_fragments.activity_home.client_home.fragments.fragmen_spare_order.Fragment_Spare_New_Orders;
...
public class OrdersSpareAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OrdersSpareAdapter(List<OrderSpareDataModel.OrderSpare> orderModelList, Context context, String user_type, Fragment fragment) {

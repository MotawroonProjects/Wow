...
public class Fragment_Client_Spare_Order_Details extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_client_spare_order_details, container, false);
        initView(view);
        return view;
    }

    public static Fragment_Client_Spare_Order_Details newInstance(OrderSpareDataModel.OrderSpare order) {
        Bundle bundle = new Bundle();
        bundle.putSerializable(TAG, order);
        Fragment_Client_Spare_Order_Details fragment_client_order_details = new Fragment_Client_Spare_Order_Details();

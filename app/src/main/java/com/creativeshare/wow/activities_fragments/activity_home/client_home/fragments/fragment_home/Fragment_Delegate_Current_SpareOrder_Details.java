...
public class Fragment_Delegate_Current_SpareOrder_Details extends Fragment {
    private static final String TAG = "ORDER";
    private ClientHomeActivity activity;
    private ImageView image_back,image_arrow,image_arrow2,image_chat,image_spare;
    private LinearLayout ll_back;
    private String current_lang;
    private TextView tv_client_name,tv_address,tv_order_state,tv_order_next_state,tv_model,tv_type,tv_year,tv_name,tv_quantity,tv_delivery;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_delegate_current_spare_order_details,container,false);
        initView(view);
        return view;
    }

    public static Fragment_Delegate_Current_SpareOrder_Details newInstance(OrderSpareDataModel.OrderSpare order)
    {
        Bundle bundle = new Bundle();
        bundle.putSerializable(TAG,order);
        Fragment_Delegate_Current_SpareOrder_Details fragment_delegate_Current_order_details = new Fragment_Delegate_Current_SpareOrder_Details();
    ...
    private void initView(View view) {
        ...
        fl_map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              activity.DisplayFragmentMapLocationDetails(Double.parseDouble(order.getClient_lat()),Double.parseDouble(order.getClient_long()),order.getClient_address());
            }
        });
        ...
        fl_update_order_state.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                activity.UpdateSpareOrderMovement(order.getClient_id(),order.getDriver_id(),order.getOrder_id(),order_state);
        ...
        app_bar.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if ((totalRange+verticalOffset)<=65)
                {
